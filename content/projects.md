...
Machine Model of Pentagon Drawing of Mini-Mental State Examination

- Developed a machine learning model for cognitive ability testing
...
### **2019/04 ~ 2019/08** `In-Class Project`

Complex Emotion Recognition - Application of Convolutional Neural Networks

- Trained a model to differentiate complex emotion recognition (vs. basic emotion recognition)

### **2018/09 ~ 2019/06** `In-Class Project`

Capstone Project on Aerospace Engineering: Unmanned Aerial Vehicle (UAV) Design

- Designed and built a motor-driven UAV through practical computations and optimization

### **2018/09 ~ 2019/01** `In-Class Project`
