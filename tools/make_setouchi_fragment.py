...
DRUGSTORE = [
    ("sv1", "保健食品", "DHC 持續型維他命 B 群", "60日", "¥710", 3),
    ("sv2", "保健食品", "DHC 持續型維他命 C", "60日", "¥700", 3),
    ("sv3", "保健食品", "DHC 維生素 D", "60日", "¥462", 5),
    ("sv4", "保健食品", "DHC 金盞花萃取物葉黃素", "60日", "¥1880", 2),
    ("sv5", "保健食品", "DHC 鋅", "60日", "¥465", 5),
    ("sv6", "保健食品", "DHC 紅藻萃取物蝦紅素", "30日", "¥1110", 4),
    ("sv7", "外用藥", "液體 OK 蹦", "10g", "¥650", 1),
